...
var operateList = ["number-of-ways-to-stay-in-the-same-place-after-some-steps","search-suggestions-system","count-servers-that-communicate","minimum-time-visiting-all-points","minimum-moves-to-move-a-box-to-their-target-location","greatest-sum-divisible-by-three","find-elements-in-a-contaminated-binary-tree","shift-2d-grid","maximum-score-words-formed-by-letters","number-of-closed-islands","reconstruct-a-2-row-binary-matrix","cells-with-odd-values-in-a-matrix","check-if-it-is-a-good-array","minimum-remove-to-make-valid-parentheses","count-number-of-nice-subarrays","minimum-swaps-to-make-strings-equal","airplane-seat-assignment-probability","tiling-a-rectangle-with-the-fewest-squares","maximum-length-of-a-concatenated-string-with-unique-characters","circular-permutation-in-binary-representation","find-positive-integer-solution-for-a-given-equation","maximum-profit-in-job-scheduling","replace-the-substring-for-balanced-string","remove-sub-folders-from-the-filesystem","check-if-it-is-a-straight-line","maximum-equal-frequency","dice-roll-simulation","queens-that-can-attack-the-king","split-a-string-in-balanced-strings","the-dining-philosophers","design-skiplist","count-vowels-permutation","path-with-maximum-gold","longest-arithmetic-subsequence-of-given-difference","play-with-chips","minimum-moves-to-reach-target-with-rotations","get-equal-substrings-within-budget","remove-all-adjacent-duplicates-in-string-ii","unique-number-of-occurrences","fizz-buzz-multithreaded","sort-items-by-groups-respecting-dependencies","smallest-string-with-swaps","ugly-number-iii","minimum-absolute-difference","reformat-department-table","swap-for-longest-repeated-character-substring","day-of-the-year","print-zero-even-odd","print-in-order","print-foobar-alternately","building-h2o","reorder-data-in-log-files","employee-importance","smallest-range-covering-elements-from-k-lists","swap-salary","exchange-seats","not-boring-movies","human-traffic-of-stadium","classes-more-than-5-students","big-countries","guess-number-higher-or-lower","peeking-iterator","trips-and-users","rising-temperature","delete-duplicate-emails","tenth-line","transpose-file","valid-phone-numbers","word-frequency","department-top-three-salaries","department-highest-salary","customers-who-never-order","duplicate-emails","employees-earning-more-than-their-managers","consecutive-numbers","rank-scores","nth-highest-salary","second-highest-salary","combine-two-tables"];
//::End refill
