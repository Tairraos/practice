...
var operateList = ["shortest-path-in-a-grid-with-obstacles-elimination","maximum-side-length-of-a-square-with-sum-less-than-or-equal-to-threshold","convert-binary-number-in-a-linked-list-to-integer","minimum-number-of-flips-to-convert-binary-matrix-to-zero-matrix","find-the-smallest-divisor-given-a-threshold","group-the-people-given-the-group-size-they-belong-to","subtract-the-product-and-sum-of-digits-of-an-integer","palindrome-partitioning-iii","count-square-submatrices-with-all-ones","number-of-burgers-with-no-waste-of-ingredients","find-winner-on-a-tic-tac-toe-game","the-dining-philosophers","fizz-buzz-multithreaded","reformat-department-table","swap-for-longest-repeated-character-substring","day-of-the-year","minimum-falling-path-sum-ii","remove-covered-intervals","element-appearing-more-than-25-in-sorted-array","print-zero-even-odd","sequential-digits","iterator-for-combination","print-in-order","print-foobar-alternately","building-h2o","reorder-data-in-log-files","employee-importance","smallest-range-covering-elements-from-k-lists","swap-salary","exchange-seats","not-boring-movies","human-traffic-of-stadium","classes-more-than-5-students","big-countries","guess-number-higher-or-lower","peeking-iterator","trips-and-users","rising-temperature","delete-duplicate-emails","tenth-line","transpose-file","valid-phone-numbers","word-frequency","department-top-three-salaries","department-highest-salary","customers-who-never-order","duplicate-emails","employees-earning-more-than-their-managers","consecutive-numbers","rank-scores","nth-highest-salary","second-highest-salary","combine-two-tables"];
//::End refill
