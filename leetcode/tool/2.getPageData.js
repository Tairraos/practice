...
var operateList = ["reformat-department-table","swap-for-longest-repeated-character-substring","day-of-the-year","reorder-data-in-log-files","smallest-range-covering-elements-from-k-lists","swap-salary","exchange-seats","not-boring-movies","human-traffic-of-stadium","classes-more-than-5-students","big-countries","trips-and-users","rising-temperature","delete-duplicate-emails","tenth-line","transpose-file","valid-phone-numbers","word-frequency","department-top-three-salaries","department-highest-salary","customers-who-never-order","duplicate-emails","employees-earning-more-than-their-managers","consecutive-numbers","rank-scores","nth-highest-salary","second-highest-salary","combine-two-tables"];
//::End refill
