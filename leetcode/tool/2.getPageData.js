...
var operateList = ["er-cha-shu-de-zui-jin-gong-gong-zu-xian-lcof","er-cha-sou-suo-shu-de-zui-jin-gong-gong-zu-xian-lcof","max-dot-product-of-two-subsequences","pseudo-palindromic-paths-in-a-binary-tree","maximum-number-of-vowels-in-a-substring-of-given-length","check-if-a-word-occurs-as-a-prefix-of-any-word-in-a-sentence","the-dining-philosophers","fizz-buzz-multithreaded","reformat-department-table","print-zero-even-odd","print-in-order","print-foobar-alternately","building-h2o","count-unique-characters-of-all-substrings-of-a-given-string","logical-or-of-two-binary-grids-represented-as-quad-trees","swap-salary","exchange-seats","not-boring-movies","human-traffic-of-stadium","classes-more-than-5-students","big-countries","trips-and-users","rising-temperature","delete-duplicate-emails","tenth-line","transpose-file","valid-phone-numbers","word-frequency","department-top-three-salaries","department-highest-salary","customers-who-never-order","duplicate-emails","employees-earning-more-than-their-managers","consecutive-numbers","rank-scores","nth-highest-salary","second-highest-salary","combine-two-tables"];
//::End refill
